...
<html>
  <head>
    <?php
      ...
      echo PHP_EOL;
      echo '    <title>' . $row['Description'] . ': Contact Us ' . '</title>' . PHP_EOL;
      echo '    <meta http-equiv="content-type" content="text/html; charset=UTF-8"/>' . PHP_EOL;
      echo '    <meta name="keywords" content="' . $row['Description'] . ', contactus"/>' . PHP_EOL;
      echo '    <meta name="description" content="Contact Us page of the ' . $row['Title'] . ' course"/>' . PHP_EOL;
    ?>
